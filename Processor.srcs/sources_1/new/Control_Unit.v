module Control_Unit(ir,r2_flag,r3_flag,ALU_control,A_bus,B_bus,d_ram/*data ram write*/,fetch,load,pc_inc,mar_inc,r2_inc,r3_inc,clk,processing_over_light);
input [15:0] ir;
input clk;
